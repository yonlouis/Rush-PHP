   ...
   <div class="row">
    ...
    <div class="col s12 m4 l4">
      ...
      <ul class="pagination center">
        <li class="waves-effect waves-red"><a href="index.php"><i class="material-icons">chevron_left</i></a></li>
        <li class="waves-effect waves-red"><a href="index.php">1</a></li>
        <li class="active waves-effect waves-light"><a href="#!">2</a></li>
        <li class="waves-effect waves-red"><a href="index3.php">3</a></li>
        <li class="waves-effect waves-red"><a href="index3.php"><i class="material-icons">chevron_right</i></a></li>
      </ul>
