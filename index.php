   ...
   <div class="row">
      ...
      <div class="card z-depth-3">
        <div class="hoverable">
          <div class="card-image">
            <img class="materialboxed" width="550" src="Images/livre_sarko.jpg">
          </div>
          <div class="card-content max-width: 30%">
    ...
    <div class="col s12 m4 l4">
      <div class="card z-depth-3">
        <div class="hoverable">
          <div class="card-image">
            <img class="materialboxed" width="550" src="Images/Bachelot.jpg">
          </div>
          <div class="card-tabs">
    ...
    <div class="col s12 m4 l4">
      <div class="card z-depth-3">
        <div class="hoverable">
          <div class="card-image">
            <img class="materialboxed" width="550" src="Images/les-francais-d-abord.jpg">
          </div>
          <div class="card-content">
      ...
      <ul class="pagination center">
        ...
        <li class="active waves-effect waves-light"><a href="#!">1</a></li>
        <li class="waves-effect waves-red"><a href="index2.php">2</a></li>
        <li class="waves-effect waves-red"><a href="index3.php">3</a></li>
        <li class="waves-effect waves-red"><a href="index2.php"><i class="material-icons">chevron_right</i></a></li>
      </ul>
